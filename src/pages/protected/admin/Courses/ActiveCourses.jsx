...
import { ACTIVE_COURSES_QUERY } from '@apollo/server/queries'
...
const ActiveCoursesPage = ({ client }) => {
  ...
  const getData = async e => {
    ...
    return {
      data: activeCourses.docs,
      page: e.page,
      totalCount: activeCourses.total,
    }
  }
...
export default withApollo(ActiveCoursesPage)
