...
const cardHeaderStyle = {
  cardHeader: {
    ...
    zIndex: '3 !important',
    '&$cardHeaderPlain,&$cardHeaderImage,&$cardHeaderContact,&$cardHeaderSignup,&$cardHeaderIcon,&$cardHeaderStats,&$warningCardHeader,&$successCardHeader,&$dangerCardHeader,&$infoCardHeader,&$primaryCardHeader': {
      margin: '0 15px',
      padding: '0',
      position: 'relative',
      color: whiteColor,
  ...
  cardHeaderImage: {
    ...
    '& img': {
      ...
      borderRadius: '6px',
      pointerEvents: 'none',
      boxShadow: `0 5px 15px -8px rgba(${hexToRgb(blackColor)}, 0.24), 
